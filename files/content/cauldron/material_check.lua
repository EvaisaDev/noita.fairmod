function material_area_checker_success(pos_x, pos_y)
	...
	if #player_id > 0 then
		...
		if comp_damagemodel ~= nil then ComponentSetValue2(comp_damagemodel, "materials_damage_proportional_to_maxhp", true) end
	...
	if world_entity_id ~= nil then
		...
		if comp_worldstate ~= nil then ComponentSetValue2(comp_worldstate, "INFINITE_GOLD_HAPPENING", true) end
	end
end

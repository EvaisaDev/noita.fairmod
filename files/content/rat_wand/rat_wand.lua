...
gun.actions = { "FAIRMOD_RAT_BITE" }

local mana_max = get_random_between_range(gun.mana_max)
local deck_capacity = gun.deck_capacity

ComponentSetValue2(ability_comp, "ui_name", get_random_from(gun.name))
...
ComponentSetValue2(ability_comp, "mana_charge_speed", get_random_between_range(gun.mana_charge_speed))

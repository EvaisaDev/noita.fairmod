    ...
    new = function(x, y)
        ...
        while #self.scratch_numbers < 16 do
            ...
            if not numbers_picked[number] then
                ...
                table.insert(self.scratch_numbers, {
                    ...
                    particle_spawned = false, -- Track if particles have been spawned
                })
            end
        end
        ...
        self.draw = function(self)
            ...
            for i, scratch_number in ipairs(self.scratch_numbers) do
                ...
                if cell_cleared and is_winning_number and not scratch_number.particle_spawned then
                    ...
                    scratch_number.particle_spawned = true
                end

...
local dialogue_read_the_words_7 = function(dialogue)
	dialogue.show({
		name = shuffle("Longest Hamis"),
		text = shuffle("On the Seventh Day, the Hamis Lord looked upon the world it had made,") .. "\n" .. shuffle(
...
local dialogue_read_the_words_4 = function(dialogue)
	dialogue.show({
		name = shuffle("Longest Hamis"),
		text = shuffle("On the Fourth Day, the Hamis Lord raised a mighty claw,") .. "\n" .. shuffle(
...
local dialogue_read_the_words_1 = function(dialogue)
	dialogue.show({
		name = shuffle("Longest Hamis"),
		text = shuffle("On the First Day, the Hamis Lord raised its many-fingered hand,") .. "\n" .. shuffle(

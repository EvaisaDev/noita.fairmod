...
teleport_delay_content = teleport_delay_content:gsub(escape([[EntityLoad( "data/entities/buildings/teleport_ending_victory_delay.xml", x_portal, y_portal )]]), escape([[

...
async_loop(function()
	...
	if(kill_frame - GameGetFrameNum() == 1)then
		...
		if(show_text)then
			...
			DrawText(gui, "mods/noita.fairmod/files/content/fishing/files/ui/characters", ((w / 2)-(width / 2)), (((h / 2)-(height / 2)) - 26) - 100, 0.4, -525, fish_name, "ff241c11", -0.5)

			width, height = TextSize(gui, "mods/noita.fairmod/files/content/fishing/files/ui/characters", 0, 0, 0.4, -525, fish_size.." kg", -0.5)
			DrawText(gui, "mods/noita.fairmod/files/content/fishing/files/ui/characters", ((w / 2)-(width / 2)), (((h / 2)-(height / 2)) + 25) - 100, 0.4, -525, fish_size.." kg", "ff241c11", -0.5)
		end

...
--[[
 
]]
...
if is_leap_year then
    ...
    void_day = void_day == "0"
end --true for void, false for not, nil for random



print(tostring(void_day))
print(tostring(void_day))
print(tostring(void_day))
print(tostring(void_day))
print(tostring(void_day))

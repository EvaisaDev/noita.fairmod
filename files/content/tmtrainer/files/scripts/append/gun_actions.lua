...
for action_type, map in ipairs(action_info_map)do
    ...
    for _, action in ipairs(map)do
        ...
        --[[
        local print_string = "TMTRAINER_" .. TMTRAINER_INDEX .. " generated with spells: ["
        for i, action in ipairs(added_actions)do
            print_string = print_string .. action.id .. ", "
        end
        print_string = print_string .. "] and twitch events: ["
        for i, twitch_event in ipairs(twitch_events)do
            print_string = print_string .. twitch_event.id .. ", "
        end

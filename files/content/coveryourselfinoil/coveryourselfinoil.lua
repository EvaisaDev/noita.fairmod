...
effect_content = effect_content:gsub("</Entity>$", function()
	return [[<LuaComponent script_source_file="mods/noita.fairmod/files/content/coveryourselfinoil/effect.lua" />]]
		.. "</Entity>"
end)

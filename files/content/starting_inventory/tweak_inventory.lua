...
starting_bomb_wand:AppendBefore(
	[[local bullshit_spells = { "BOMB", "DYNAMITE", "MINE", "ROCKET", "GRENADE", "BLACK_HOLE_DEATH_TRIGGER", "GRENADE_TRIGGER", "LASER_LUMINOUS_DRILL", "TORCH", "PEBBLE", "TNTBOX_BIG", "FAIRMOD_DYNAMITE", "FAIRMOD_BOMB", "FAIRMOD_ROCKET", "FAIRMOD_LONG_BOMB", "FAIRMOD_LONG_DYNAMITE" }]]
)

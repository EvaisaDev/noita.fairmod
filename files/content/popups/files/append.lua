--translations
local _, _, _, hours, mins, secs = GameGetDateAndTimeLocal()
...
for line in string.gmatch(defaultText, "[^\n]+") do
    if firstLine then
        ...
        if rnd < 0.001 then middlePortion = "https://github.com/Ramiels/copis_things/" .. middlePortion
        elseif rnd < 0.011 then middlePortion = "Download Copi's Things! - " .. middlePortion end

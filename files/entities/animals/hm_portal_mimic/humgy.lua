...
if ( Random( 1, 4 ) > 1 ) then
    ...
    if #EntityGetInRadiusWithTag(x, y, 25, "player_unit") > 0 then
        shoot_projectile( entity_id, "mods/noita.fairmod/files/entities/animals/hm_portal_mimic/tentacle.xml", x, y, vel_x * 1.1, vel_y * 1.1 )
        shoot_projectile( entity_id, "mods/noita.fairmod/files/entities/animals/hm_portal_mimic/tentacle.xml", x, y, vel_x * 0.9, vel_y * 0.9 )
        shoot_projectile( entity_id, "mods/noita.fairmod/files/entities/animals/hm_portal_mimic/tentacle.xml", x, y, vel_x, vel_y )
    end
end